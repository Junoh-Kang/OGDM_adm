...
# CUDA_VISIBLE_DEVICES=0 python src/evaluate.py -metrics prdc --N 50000 --dset1 data/cifar10_32 --real_feat_path data/cifar10_prdc2.npz --dset2 data/cifar10_32 --batch_size 256
